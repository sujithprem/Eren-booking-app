    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
       ...
       <div className='relative flex flex-col gap-3'>
        ...
        <div className='flex items-center gap-2 text-gray-300'><StarIcon className='w-5 h-5 text-red-400 fill-amber-300'/>{show.movie.vote_average.toFixed(1)}User Rating</div>
        ...
        <div className='flex items-center flex-wrap gap-4 mt-4'>
          ...
          <a href="#dataSelect" className='px-10 py-3 text-sm bg-red-500 hover:bg-red-600 transition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
     ...
     <div className='overflow-x-auto no-scrollbar mt-8 pb-4'>
      ...
      <Dataselect dateTime={show.dataTime} id={id}/>
      ...
      <div onClick={()=> {navigate('/movies'); scrollTo(0,0)}} className='flex justify-center mt-20'>
        <button className='px-10 py-3 text-sm bg-red-500 hover:bg-red-600 transition rounded-md font-medium cursor-pointer'>Show more</button>
      </div>
